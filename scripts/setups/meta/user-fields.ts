...
const SEI_APIOGS: ServiceLayerUserFieldReq[] = [
  {
    Name: 'SEI_Method',
    Description: 'Method',
...
const SEI_COU_TENANTS: ServiceLayerUserFieldReq[] = [
  {
    Name: 'SEI_DBName',
...
const SEI_COU_LOOKUPS: ServiceLayerUserFieldReq[] = [
  {
    Name: 'SEI_LookUpType',
...
const SEI_SVLOGS: ServiceLayerUserFieldReq[] = [
  {
    Name: 'SEI_Service',
...
const SEI_TRACKER: ServiceLayerUserFieldReq[] = [
  {
    Name: 'SEI_TenantCode',
    Description: 'SBO Tenant Code',
...
const SEI_SERVICES: ServiceLayerUserFieldReq[] = [
  {
    Name: 'SEI_Desc',
...
const SetupUserFields: ServiceLayerUserFieldReq[] = []
